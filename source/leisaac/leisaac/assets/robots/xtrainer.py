...
XTRAINER_GRIPPER_EFFORT_LIMIT_SIM = float(os.environ.get("XTRAINER_GRIPPER_EFFORT_LIMIT_SIM", "50.0"))
XTRAINER_GRIPPER_VELOCITY_LIMIT_SIM = float(os.environ.get("XTRAINER_GRIPPER_VELOCITY_LIMIT_SIM", "1.0"))
XTRAINER_GRIPPER_STIFFNESS = float(os.environ.get("XTRAINER_GRIPPER_STIFFNESS", "400.0"))
XTRAINER_GRIPPER_DAMPING = float(os.environ.get("XTRAINER_GRIPPER_DAMPING", "40.0"))
...
XTRAINER_FOLLOWER_CFG = ArticulationCfg(
    ...
    actuators={
        ...
        "xtrainer_gripper": ImplicitActuatorCfg(
            ...
            effort_limit_sim=XTRAINER_GRIPPER_EFFORT_LIMIT_SIM,
            velocity_limit_sim=XTRAINER_GRIPPER_VELOCITY_LIMIT_SIM,
            stiffness=XTRAINER_GRIPPER_STIFFNESS,
            damping=XTRAINER_GRIPPER_DAMPING,
        )
    },
